...
> Pro hide text in images (lsb encoding)

[![PyPI version](https://badge.fury.io/py/pro-steganography.svg)](https://pypi.org/project/pro-steganography/)
...
```bash
pip install pro-steganography
```

## Quick Start

```python
from pro_steganography import steganography
...
from pro_steganography import batch
